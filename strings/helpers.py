...
HELP_13 = """ 
———————————
✦︙ تشغيل + الاسم او الرابط او بالرد لتشغيله
———————————
✦︙ قناه + الاسم او الرابط او بالرد لتشغيله في القناة مباشرة
———————————
✦︙ ربط + معرف القناة لربطها بالمجموعه و تشغيل الموسيقى فيها 
———————————
✦︙ انهاء ←  لانهاء تشغيل الموسيقى 
———————————
✦︙ وقف ←  لايقاف الموسيقى مؤقتاً 
———————————
✦︙ استمر ←  لاكمال تشغيل الموسيقى المتوقفه 
———————————
✦︙ تخطي ←  لتخطي الموسيقى الحاليه الى الموسيقى التاليه 
———————————
✦︙ كرر + عدد المرات ←  لتكرار الموسيقى المشتغله
———————————
✦︙ بنك  ←  لمعرفة سرعة البوت 
———————————
✦︙ اعدادات ←  لاظهار اعدادات بوت الموسيقى داخل المجموعه 
———————————
✦︙ القائمه ← لعرض قائمة التشغيل في المجموعه 
———————————
✦︙ ريستارت ←  لاعادة تشغيل البوت داخل المجموعه 
———————————
✦︙ حدث ←  لتحديث قائمة المشرفين داخل المجموعه
———————————
✦︙ تحميل + اسم الموسيقى او الرابط ← لتحميل الموسيقى من اليوتيوب صوت او فيديو في الخاص
"""
